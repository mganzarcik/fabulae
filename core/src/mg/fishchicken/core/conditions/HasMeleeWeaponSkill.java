...
/**
 * Returns true if the supplied character has a melee weapon skill
 * larger or equal to the value of the parameter minimumSkillRank. 
 * If the parameter is not defined, it is considered 1.
 * <br /><br /> 
 * Any of the following skills are considered melee weapon skills: 
 * <ul>
 *  <li>Axe
 *  <li>Dagger
 *  <li>Staff
 ...
 * 
 * <pre>
 * &lt;hasMeleeWeaponSkill minimumSkillRank="3" /&gt;
 * </pre>
 * 
 * @author ANNUN
 *
 */
public class HasMeleeWeaponSkill extends HasSkill {
	...
	public String toUIString() {
		...
		fsb.append(Strings.getString(STRING_TABLE, "anyMeleeWeaponSkill"));
