...
public class RayHandler implements Disposable {
	...
	public RayHandler(World world, ShaderProgram shader) {
		this(world, Gdx.graphics.getWidth() / 4, Gdx.graphics
				.getHeight() / 4, shader);
	}
	...
	public RayHandler(World world, int fboWidth, int fboHeigth) {
		this(world, fboWidth, fboHeigth, LightShader.createLightShader());
	}
	 ...
	 * @param fboHeigth
	 */
	public RayHandler(World world, int fboWidth, int fboHeigth, ShaderProgram shader) {
		this.world = world;
